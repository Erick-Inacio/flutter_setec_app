...
mixin _$Speaker {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, user, company, position, bio,
      isApproved, adminUid, const DeepCollectionEquality().hash(socialMedia));

  @override
  String toString() {
    return 'Speaker(id: $id, user: $user, company: $company, position: $position, bio: $bio, isApproved: $isApproved, adminUid: $adminUid, socialMedia: $socialMedia)';
  }
}
...
class _Speaker implements Speaker {
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, user, company, position, bio,
      isApproved, adminUid, const DeepCollectionEquality().hash(_socialMedia));
